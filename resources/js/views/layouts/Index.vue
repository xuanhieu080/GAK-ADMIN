    ...
    <div>
      ...
      >
        ...
        <div class="flex flex-col flex-1 w-full h-full relative" :class="{'main-full': isToggleDesktop, 'main': authStore.user.email}">
          ...
          <!--                <nav class="shadow flex px-5 py-3 text-gray-700 border border-gray-200 bg-gray-50" aria-label="Breadcrumb">-->
          ...
          <!--                                <a href="#" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2">Templates</a>-->
          <!--                            </div>-->
          <!--                        </li>-->
