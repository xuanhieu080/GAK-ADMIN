        ...
        <template #filters v-if="page.toggleFilters">
            <Filters @clear="onFiltersClear">
                <FiltersRow>
                    ...
                    <FiltersCol>
                        <TextInput name="zalo" :label="trans('labels.zalo')" v-model="mainQuery.filters.zalo.value"></TextInput>
                    </FiltersCol>
                    <FiltersCol>
                        <TextInput name="telegram" :label="trans('labels.telegram')" v-model="mainQuery.filters.telegram.value"></TextInput>
                    </FiltersCol>
                </FiltersRow>
            </Filters>
        </template>
...
export default defineComponent({
    ...
    setup() {
        ...
        const page = reactive({
            id: 'list_supports',
            title: trans('global.pages.supports'),
            breadcrumbs: [
                {
        ...
        const table = reactive({
            headers: {
                ...
                phone: trans('labels.phone'),
                zalo: trans('labels.zalo'),
                telegram: trans('labels.telegram'),
            },
            sorting: {
                name: true,
            },
