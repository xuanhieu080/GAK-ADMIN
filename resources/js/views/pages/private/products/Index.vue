        ...
        <template #filters v-if="page.toggleFilters">
            <Filters @clear="onFiltersClear">
                <FiltersRow>
                    ...
                    <FiltersCol>
                        <Dropdown name="categories" server="categories" :multiple="true" :label="trans('labels.categories')" v-model="mainQuery.filters.category_id.value"></Dropdown>
                    </FiltersCol>
                </FiltersRow>
            </Filters>
        </template>
...
export default defineComponent({
    ...
    setup() {
        ...
        const page = reactive({
            id: 'list_products',
            title: trans('global.pages.products'),
            breadcrumbs: [
                {
