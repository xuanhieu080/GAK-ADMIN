<template>
  <Page :title="page.title" :breadcrumbs="page.breadcrumbs" :actions="page.actions" @action="onAction"
    ...
    <Panel>
      <Form id=" edit-post-group" @submit.prevent="onSubmit">
        <Tab :tabs="tabs" @set-index="updateTabIndex" :active-index="activeTab">
          ...
          <div v-show="activeTab === 2">
            ...
            <TextInput class="mb-4" type="textarea" :rows="5" name="description_en" v-model="form.description_en"
                       error-input="description_en" label="Mô tả tiếng anh"/>
...
function onSubmit() {
  ...
  service.handleUpdate(' edit-post-group', route.params.id, reduceProperties(form, 'roles', 'id')).then((response) => {
