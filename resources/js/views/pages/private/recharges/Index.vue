        ...
        <template #filters v-if="page.toggleFilters">
            <Filters @clear="onFiltersClear">
                <FiltersRow>
                    ...
                    <FiltersCol>
                        <Dropdown name="banks" server="banks" :multiple="true" :label="trans('labels.bank')" v-model="mainQuery.filters.bank_id.value"></Dropdown>
                    </FiltersCol>
                    <FiltersCol>
                        <Dropdown name="customers" server="customers" :multiple="true" :label="trans('labels.customers')" v-model="mainQuery.filters.customer_id.value"></Dropdown>
                    </FiltersCol>
                </FiltersRow>
            </Filters>
        </template>
...
export default defineComponent({
    ...
    setup() {
        ...
        const page = reactive({
            id: 'list_recharges',
            title: trans('global.pages.recharges'),
            breadcrumbs: [
                {
