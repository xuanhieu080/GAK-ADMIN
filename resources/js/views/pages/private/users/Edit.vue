    ...
    <Page :title="page.title" :breadcrumbs="page.breadcrumbs" :actions="page.actions" @action="onAction" :is-loading="page.loading">
        <Panel>
            <Form id="edit-user" @submit.prevent="onSubmit">
                <TextInput class="mb-4" type="text" :required="true" error-input="first_name" name="first_name" v-model="form.first_name" :label="trans('labels.first_name')"/>
                <TextInput class="mb-4" type="text" :required="true" error-input="last_name" name="last_name" v-model="form.last_name" :label="trans('labels.last_name')"/>
                <TextInput class="mb-4" type="email" :required="true" error-input="name" name="email" v-model="form.email" :label="trans('labels.email')"/>
