        ...
        <Tab :tabs="tabs" @set-index="updateTabIndex" :active-index="activeTab">
          ...
          <div v-show="activeTab === 1">
            ...
            <TextInput v-if="form.is_button" class="mb-4" type="text" :required="true" error-input="link" name="link"
                       v-model="form.link"
                       label="Liên kết"/>
            <TextInput v-else class="mb-4" type="text" :required="true" error-input="slug" name="slug"
                       v-model="form.slug"
                       label="Slug"/>
          ...
          <div v-show="activeTab === 2">
            <TextInput class="mb-4" type="text" error-input="name" name="name_en" v-model="form.name_en"
                       :label="trans('labels.name')"/>
            ...
            <TextInput v-if="form.is_button" class="mb-4" type="text" error-input="link_en" name="link_en"
                       ...
                       label="Liên kết"/>
            <TextInput v-else class="mb-4" type="text" error-input="slug_en" name="slug_en"
